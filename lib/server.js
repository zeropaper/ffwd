...
function server(configuration, options) {
  ...
  schemaOrg(configuration.resources || ['Thing'], {}, function(err) {
    ...
    app.configure('development', function(){
      ...
      app.staticDirs.push(path.join(projectDir, '.tmp'));
      app.use(express.static(path.join(projectDir, appPath)));
      app.staticDirs.push(path.join(projectDir, appPath));
      app.use(express.static(path.join(projectDir, viewsPath)));
      app.staticDirs.push(path.join(projectDir, viewsPath));
    ...
    app.configure('production', function(){
      ...
      app.staticDirs.push(path.join(projectDir, 'public'));
      app.set('views', viewsPath);
    });
    ...
    app.configure(function(){
      ...
      // http://stackoverflow.com/a/19611997/662964
    ...
    // API definition
    app.get('/api/v1/definition/:thingType/property/:thingProperty', api.defineThingType);
    ...
    app.get('/api/v1/:thingType/:thingId/:thingProperty', api.list);
